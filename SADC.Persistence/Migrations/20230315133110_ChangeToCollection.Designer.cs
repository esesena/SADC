...
namespace SADC.Persistence.Migrations
{
    ...
    [Migration("20230315133110_ChangeToCollection")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EmployeeFarm", b =>
                {
                    ...
                    b.HasKey("EmployeesId", "FarmsId");

                    b.HasIndex("FarmsId");

                    b.ToTable("EmployeeFarm");
                });
            ...
            modelBuilder.Entity("EmployeeFarm", b =>
                {
                    b.HasOne("SADC.Domain.Employee", null)
                        .WithMany()
                        .HasForeignKey("EmployeesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SADC.Domain.Farm", null)
                        .WithMany()
