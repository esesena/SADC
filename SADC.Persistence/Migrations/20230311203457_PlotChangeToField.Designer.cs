...
namespace SADC.Persistence.Migrations
{
    ...
    [Migration("20230311203457_PlotChangeToField")]
    partial class PlotChangeToField
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FieldPlanting", b =>
                {
                    ...
                    b.HasKey("FieldId", "PlantingId");

                    b.HasIndex("PlantingId");

                    b.ToTable("FieldPlanting");
                });
            ...
            modelBuilder.Entity("FieldPlanting", b =>
                {
                    b.HasOne("SADC.Domain.Field", null)
                        .WithMany()
                        .HasForeignKey("FieldId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SADC.Domain.Planting", null)
                        .WithMany()
